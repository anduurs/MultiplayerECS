...
namespace Lidgren.Network
{
	...
	public partial class NetPeer
	{
		...
		{
			// Note: this group entityNameDef is PER SENDING/NetPeer; ie. same entityNameDef is sent to all recipients;
			// this should be ok however; as long as recipients differentiate between same entityNameDef but different sender
